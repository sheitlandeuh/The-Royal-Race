...
const sound=(()=>{let A=null,master,sfx,mus,crowd,crowdGain,noiseBuf,musicTimer=0,gallopT=0;
 ...
 return{volumes,gallop,crowdStart,crowdLevel,crowdStop,bell,gates,coin,fanfare,music,say,init,get ctx(){return A},get musicBus(){return mus},get sfxBus(){return sfx},noise,thud,tone}})();
